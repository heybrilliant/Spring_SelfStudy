...
<mapper namespace="com.project.gymcarry.dao.MemberDao">
	...
	<!-- 멤버 아이디 찾기  -->
 	<select id="findmemberid" parameterType="com.project.gymcarry.dao.MemberDao" resultType="String">
		select mememail from member where memname = #{memname} and memphone = #{memphone} 
	</select> 
	
	<!-- 캐리 아이디 찾기 -->
	<select id="findcarryid" parameterType="com.project.gymcarry.dao.MemberDao" resultType="String">
		select cremail from carry where crname = #{crname} and crphone = #{crphone} 
	</select>
	
	<!-- 멤버 비밀번호 찾기  -->
	<select id="findPassword" parameterType="com.project.gymcarry.dao.MemberDao" resultType="String">
		select mememail from member where memname = #{memname} and mememail = #{mememail}
	</select>
	
	<!-- 멤버 임시 비밀번호 -->
	<update id="setpassword" parameterType="Map">
		update member set mempw = #{mempw} where memname = #{memname} and mememail = #{mememail}
	</update>
