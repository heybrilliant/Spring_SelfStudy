            ...
            <div class="form_txtInput">
                ...
                <div class="edit_form">
                    <div class="profile_form">
                        ...
                        <a href="<input type=" file" name="carryphoto">">프로필 사진 수정</a>
                    </div>
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <th><span>이름</span></th>
                                <td>
                                    <input type="text" id="name" placeholder="회원 이름(db)" disabled>
                                </td>
                            </tr>
                            <tr>
                                <th><span>이메일 주소 </span></th>
                                <td>
                                    <input type="text" id="email" placeholder="이메일 주소(db)" disabled>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="selectbox">
                                        <input type="radio" name="choice" value="남자"> 남자 <input type="radio"
                                            name="choice" value="여자"> 여자
                                    </div>
                                </td>
                            </tr>
                        </tbody>
